    ...
    <>
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-sky-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-sky-500/20 px-4 py-2 rounded-full mb-6">
            <i className="fas fa-handshake text-sky-400"></i>
            <span className="text-sky-300 font-bold text-sm uppercase">Partner Program</span>
          </div>
          ...
          <a
            ...
            className="inline-block px-8 py-4 bg-gradient-to-r from-sky-500 to-sky-600 text-white font-black text-lg rounded-xl hover:from-sky-600 hover:to-sky-700 transition-all shadow-xl hover:scale-105"
          >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Benefit 1 */}
            <div className="bg-gradient-to-br from-sky-50 to-green-50 rounded-2xl p-8 border-2 border-sky-200 hover:border-sky-500 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200">
              ...
              <div className="text-center mb-6">
                <p className="text-5xl font-black text-sky-600">15%</p>
                <p className="text-gray-600 mt-2">Commission per sale</p>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-700">
                  <i className="fas fa-check text-sky-600"></i>
            ...
            {/* Professional */}
            <div className="bg-white rounded-2xl p-8 shadow-xl border-4 border-sky-500 relative">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200">
              ...
              <div className="text-center mb-6">
                <p className="text-5xl font-black text-sky-600">30%</p>
                <p className="text-gray-600 mt-2">Commission per sale</p>
              </div>
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-700">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-20 h-20 bg-sky-600 text-white rounded-full flex items-center justify-center text-3xl font-black mx-auto mb-6 shadow-lg">
                1
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-white text-sky-600 font-black text-lg rounded-xl hover:bg-sky-50 transition-all shadow-xl"
            >
              <i className="fab fa-whatsapp mr-2"></i>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200">
              <h3 className="text-xl font-bold text-gray-900 mb-2 flex items-center gap-2">
                <i className="fas fa-question-circle text-sky-600"></i>
