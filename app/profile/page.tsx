  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="relative">
              <div className="w-[120px] h-[120px] rounded-full border-4 border-sky-600 bg-gradient-to-br from-sky-600 to-cyan-600 flex items-center justify-center text-white text-4xl font-black select-none">
                {userData.name
                  .split(' ')
                  .map((n) => n[0])
                  .join('')
              ...
              <button className="absolute bottom-0 right-0 w-10 h-10 bg-sky-700 text-white rounded-full flex items-center justify-center hover:bg-sky-800 shadow-lg">
            ...
            <div className="flex gap-4">
              <div className="text-center bg-sky-50 rounded-xl px-6 py-4">
                <p className="text-3xl font-black text-sky-700">{userData.totalOrders}</p>
        ...
        {/* Promo Code Card */}
        {promo && (
          <div className="relative overflow-hidden rounded-2xl shadow-lg mb-6 bg-gradient-to-r from-sky-700 via-sky-700 to-cyan-600 p-6 md:p-8">
            ...
            <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-white rounded-xl px-5 py-3 border-2 border-dashed border-white/60 shadow-inner">
                  ...
                  <p className="text-2xl font-black text-sky-800 font-mono tracking-wider">{promo.code}</p>
                </div>
                <button
                  onClick={copyPromo}
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-sky-700 text-white rounded-lg font-bold hover:bg-sky-800 transition-colors"
                  >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-sky-600 focus:outline-none disabled:bg-gray-50"
                    />
                  </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-sky-600 focus:outline-none"
                        />
                      </div>
                      <div>
            ...
            {activeTab === 'orders' && (
              <div>
                ...
                <div className="space-y-4">
                  {orders.map((order) => (
                    <div key={order.id} className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200 hover:border-sky-600 transition-colors">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-4">
                          <span className="text-2xl font-black text-sky-700">{order.price}</span>
                          <Link
              ...
              <div>
                ...
                <div className="space-y-4">
                  {licenses.map((license) => (
                    <div key={license.id} className="bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl p-6 border-2 border-sky-200">
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <button className="px-4 py-2 bg-sky-700 text-white rounded-lg font-bold hover:bg-sky-800 transition-colors">
                              <i className="fas fa-copy"></i>
                            </button>
                          </div>
                          <div className="flex gap-4 text-sm text-gray-600">
                            <span><i className="fas fa-calendar mr-2 text-sky-700"></i>Purchased: {license.purchaseDate}</span>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input type="checkbox" defaultChecked className="w-5 h-5 text-sky-700" />
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                      <input type="checkbox" className="w-5 h-5 text-sky-700" />
