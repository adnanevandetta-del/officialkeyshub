      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 py-20">
          <div className="max-w-2xl mx-auto px-4 text-center">
            ...
            <Link
              href="/"
              className="inline-block px-8 py-4 bg-emerald-600 text-white font-bold rounded-lg hover:bg-emerald-700 transition-colors"
            >
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-gray-200">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <i className="fab fa-whatsapp text-emerald-600 text-3xl"></i>
                      <div className="text-left">
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <div className="flex items-center justify-center gap-6 text-xs text-gray-600">
                    <div className="flex flex-col items-center">
                      <i className="fas fa-shield-alt text-emerald-600 text-xl mb-1"></i>
                      <span>Secure</span>
                    </div>
                    <div className="flex flex-col items-center">
