          ...
          {filteredOrders.length === 0 ? (
            ...
            <div className="space-y-4">
              {filteredOrders.map((order) => (
                <div key={order.id} className="bg-white rounded-2xl shadow-lg p-4 md:p-6 border-2 border-gray-200 hover:border-sky-600 transition-all">
                  {/* Order Header */}
                    ...
                    {order.items.map((item, idx) => (
                      <div key={idx} className="flex flex-col md:flex-row md:items-center justify-between gap-3 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="text-right md:text-left md:w-32">
                          <p className="font-bold text-sky-700">{item.price}</p>
                        </div>
                        {item.license && (
                          <div className="md:flex-1">
                            <div className="bg-white border-2 border-sky-600 rounded-lg p-3">
                              <p className="text-xs text-gray-600 mb-1 flex items-center gap-1">
                                <i className="fas fa-key text-sky-700"></i>
                                License Key:
                              </p>
                              <p className="font-mono text-sm font-bold text-gray-900 break-all">{item.license}</p>
                              <button className="text-xs text-sky-700 hover:text-sky-800 font-semibold mt-2 flex items-center gap-1">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <a
                        ...
                        className="px-4 py-2 bg-sky-700 text-white rounded-lg font-semibold hover:bg-sky-800 transition-colors text-sm"
                      >
