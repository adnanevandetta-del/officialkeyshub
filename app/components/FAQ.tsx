    ...
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <span className="inline-block bg-sky-100 text-sky-800 border border-sky-400 px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider mb-4">
            FAQ
          </span>
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-md border-2 border-gray-200 hover:border-sky-600 transition-all overflow-hidden"
            >
              <button
              ...
              >
                ...
                <i
                  ...
                  } text-sky-700 text-xl flex-shrink-0 transition-transform`}
                ></i>
              </button>
              {openIndex === index && (
        ...
        <div className="text-center mt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-sky-600 to-sky-700 text-white font-bold rounded-xl hover:from-sky-700 hover:to-sky-800 transition-all shadow-lg"
          >
