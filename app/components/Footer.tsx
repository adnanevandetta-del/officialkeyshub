      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-slate-800">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/#products" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Products
                </Link>
              </li>
              <li>
                <Link href="/payment-methods" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Payment Methods
                </Link>
              </li>
              <li>
                <Link href="/activation-guide" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Activation Guide
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/partner-program" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Partner Program
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/refund-policy" className="text-slate-400 hover:text-sky-400 transition-colors text-sm">
                  Refund Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <i className="fas fa-map-marker-alt text-sky-400 mt-1 text-sm"></i>
                <a
              ...
              <li className="flex items-start gap-2">
                <i className="fas fa-envelope text-sky-400 mt-1 text-sm"></i>
                <a
                  href="mailto:digitalkeyhubllc@gmail.com"
                  className="text-slate-400 hover:text-sky-400 transition-colors text-sm break-all"
                >
                  digitalkeyhubllc@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <i className="fas fa-phone text-sky-400 mt-1 text-sm"></i>
                <a
              ...
              <li className="flex items-start gap-2">
                <i className="fab fa-whatsapp text-sky-400 mt-1 text-sm"></i>
                <a
        ...
        <div className="mb-6 flex flex-col md:flex-row items-center justify-center gap-3 md:gap-5 rounded-xl border border-slate-800 bg-slate-900/50 px-5 py-4 text-center md:text-left">
          <div className="flex items-center gap-3">
            <span className="flex-shrink-0 w-10 h-10 rounded-lg bg-sky-500/15 flex items-center justify-center">
